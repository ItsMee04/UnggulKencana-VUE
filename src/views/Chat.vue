<template>
  <div class="content">
                ...
                <div class="swiper-slide">
                  <div class="top-contacts-box">
                    <div class="profile-img online">
                      <img src="/src/assets/img/avatar/avatar-2.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="top-contacts-box">
                    <div class="profile-img online">
                      <img src="/src/assets/img/avatar/avatar-1.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="top-contacts-box">
                    <div class="profile-img online">
                      <img src="/src/assets/img/avatar/avatar-7.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="top-contacts-box">
                    <div class="profile-img online">
                      <img src="/src/assets/img/avatar/avatar-5.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="top-contacts-box">
                    <div class="profile-img online">
                      <img src="/src/assets/img/avatar/avatar-3.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
              ...
              <li class="user-list-item">
                <a href="javascript:void(0);">
                  <div>
                    <div class="avatar avatar-online">
                      <img
                        src="/src/assets/img/avatar/avatar-9.jpg"
                        class="rounded-circle"
                        alt="image"
                      />
                    </div>
              ...
              <li class="user-list-item">
                <a href="javascript:void(0);">
                  <div>
                    <div class="avatar">
                      <img
                        src="/src/assets/img/avatar/avatar-7.jpg"
                        class="rounded-circle"
                        alt="image"
                      />
                    </div>
                    ...
                    <div class="chat-action-col">
                      ...
                      >
                        <a href="#" class="dropdown-item message-info-left"
                          ><span><i class="bx bx-info-circle"></i></span>Message
                          Info
                        </a>
                        <a href="#" class="dropdown-item"
                ...
                <div class="message-content">
                  ...
                  <div class="chat-voice-group">
                    <ul>
                      ...
                      <li>
                        <img
                          src="/src/assets/img/icons/voice.svg"
                          alt="image"
                        />
                      </li>
                      <li>0:05</li>
            ...
            <div class="chats">
              ...
              <div class="chat-content">
                  ...
                  <div class="chat-action-btns ms-2">
                    <div class="chat-action-col">
                      ...
                      >
                        ...
                        >
                        <a href="#" class="dropdown-item"
                          ><span><i class="bx bxs-star"></i></span>Unstar
                          Message</a
                        >
                        <a
                          href="#"
                ...
                <div class="message-content award-link chat-award-link">
                  ...
                  >
                  <img src="/src/assets/img/sending-img.png" alt="img" />
                  <div class="emoj-group">
                    <ul>
                      <li class="emoj-action">
                        <a href="javascript:void(0);"
                    ...
                    <ul class="nav mb-0">
                      <li>
                        <div class="image-download-col">
                          <a
                            href="/src/assets/img/media/media-02.jpg"
                            data-fancybox="gallery"
                            class="fancybox"
                          >
                            <img
                              src="/src/assets/img/media/media-02.jpg"
                              alt=""
                            />
                          </a>
                        </div>
                      ...
                      <li>
                        <div class="image-download-col">
                          <a
                            href="/src/assets/img/media/media-03.jpg"
                            data-fancybox="gallery"
                            class="fancybox"
                          >
                            <img
                              src="/src/assets/img/media/media-03.jpg"
                              alt=""
                            />
                          </a>
                        </div>
                      ...
                      <li>
                        <div class="image-download-col image-not-download">
                          <a
                            href="/src/assets/img/media/media-01.jpg"
                            data-fancybox="gallery"
                            class="fancybox"
                          >
                            <img
                              src="/src/assets/img/media/media-01.jpg"
                              alt=""
                            />
                            <span>10+</span>
                          </a>
              ...
              <div class="chat-content">
                ...
                <div class="message-content review-files">
                  <p class="d-flex align-items-center">
                    Please check and review the files<span class="ms-1 d-flex"
                      ><img
                        src="/src/assets/img/icons/smile-chat.svg"
                        alt="Icon"
                    /></span>
                  </p>
                ...
                <div class="like-chat-grp">
                  <ul>
                    <li class="like-chat">
                      <a href="javascript:void(0);"
                        >2<img src="/src/assets/img/icons/like.svg" alt="Icon"
                      /></a>
                    </li>
                    <li class="comment-chat">
                      <a href="javascript:void(0);"
                        >2<img src="/src/assets/img/icons/heart.svg" alt="Icon"
                      /></a>
                    </li>
                  </ul>
                </div>
    ...
    <!-- Right sidebar -->
    <div
      class="right-sidebar right_sidebar_profile right-side-contact hide-right-sidebar"
      id="middle1"
    >
                  ...
                  <ul class="nav share-media-img mb-0">
                    <li>
                      <a
                        ...
                        class="fancybox"
                      >
                        <img src="/src/assets/img/media/media-01.jpg" alt="" />
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        class="fancybox"
                      >
                        <img src="/src/assets/img/media/media-02.jpg" alt="" />
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        class="fancybox"
                      >
                        <img src="/src/assets/img/media/media-03.jpg" alt="" />
                      </a>
                    </li>
                    <li>
                      <a
                        href="/src/assets/img/media/media-04.jpg"
                        data-fancybox="gallery"
                        class="fancybox"
                      >
                        <img src="/src/assets/img/media/media-04.jpg" alt="" />
                      </a>
                    </li>
                    <li>
                      <a
                        href="/src/assets/img/media/media-05.jpg"
                        data-fancybox="gallery"
                        class="fancybox"
                      >
                        <img src="/src/assets/img/media/media-05.jpg" alt="" />
                      </a>
                    </li>
                    <li class="blur-media">
                      <a
                ...
                <div class="tab-pane fade" id="Participants">
                  <ul class="nav share-media-img mb-0">
                    ...
                    <li>
                      ...
                      >
                        <img
                          src="/src/assets/img/media/media-04.jpg"
                          alt="img"
                        />
                        <span><i class="bx bx-play-circle"></i></span>
                      </a>
                    ...
                    <li>
                      ...
                      >
                        <img
                          src="/src/assets/img/media/media-05.jpg"
                          alt="img"
                        />
                        <span><i class="bx bx-play-circle"></i></span>
                      </a>
                ...
                <div class="tab-pane fade" id="link">
                  <div class="media-link-grp">
                    <div class="link-img">
                      <a href="javascript:void(0);"
                        ><img
                          src="/src/assets/img/media/media-link-01.jpg"
                          alt="Img"
                      /></a>
                    </div>
                  ...
                  <div class="media-link-grp mb-0">
                    <div class="link-img">
                      <a href="javascript:void(0);"
                        ><img
                          src="/src/assets/img/media/media-link-02.jpg"
                          alt="Img"
                      /></a>
                    </div>
                    <div class="media-link-detail">
