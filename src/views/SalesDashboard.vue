    ...
    <div class="welcome d-lg-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center welcome-text">
        <h3 class="d-flex align-items-center">
          <img src="/src/assets/img/icons/hi.svg" alt="img" />&nbsp;Hi John
          Smilga,
        </h3>
        &nbsp;
    ...
    <div class="row sales-cards">
      <div class="col-xl-6 col-sm-12 col-12">
        ...
        >
          <div>
            ...
            <h3>
              $<span class="counters" data-count="95000.45">95000.45</span>
            </h3>
            <p class="sales-range">
          ...
          <img src="/src/assets/img/icons/weekly-earning.svg" alt="img" />
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 col-12">
        <div class="card color-info bg-primary mb-4">
          <img src="/src/assets/img/icons/total-sales.svg" alt="img" />
      ...
      <div class="col-xl-3 col-sm-6 col-12">
        <div class="card color-info bg-secondary mb-4">
          <img src="/src/assets/img/icons/purchased-earnings.svg" alt="img" />
                    ...
                    <td>
                      <div class="product-info">
                        <a href="product-list.html" class="product-img">
                          <img
                            src="/src/assets/img/products/stock-img-01.png"
                            alt="product"
                          />
                        </a>
                        <div class="info">
                  ...
                  <tr>
                    <td>
                      <div class="product-info">
                        <a href="product-list.html" class="product-img">
                          <img
                            src="/src/assets/img/products/stock-img-06.png"
                            alt="product"
                          />
                        </a>
                        <div class="info">
              ...
              <table class="table table-borderless recent-transactions">
                ...
                <tbody>
                  <tr>
                      ...
                      <div class="product-info">
                        ...
                        <div class="info">
                          ...
                          <span class="dull-text d-flex align-items-center"
                            ><i data-feather="clock" class="feather-14"></i>15
                            Mins</span
                          >
                        </div>
                      </div>
                    ...
                    <td>
                      <span class="badge background-less border-success"
                        >Success</span
                      >
                    </td>
                    <td>$1,099.00</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="product-info">
                        ...
                        <div class="info">
                          ...
                          <span class="dull-text d-flex align-items-center"
                            ><i data-feather="clock" class="feather-14"></i>10
                            Mins</span
                          >
                        </div>
                      </div>
                    ...
                    <td>
                      <span class="badge background-less border-danger"
                        >Canceled</span
                      >
                    </td>
                    <td>$600.55</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge background-less border-primary"
                        >Pending</span
                      >
                    </td>
                    <td>$1,099.00</td>
            ...
            <div class="graph-sets">
              <div class="dropdown dropdown-wraper">
                <button
                  ...
                  aria-expanded="false"
                >
                  <i data-feather="calendar" class="feather-14"></i>2023
                </button>
