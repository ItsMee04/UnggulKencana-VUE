<template lang="">
        ...
        <ul>
            ...
            <ul>
              ...
              <li>
                <a href="sub-categories.html"
                  ><i data-feather="speaker"></i><span>Sub Category</span></a
                >
              </li>
              <li>
              ...
              <li>
                <a href="qrcode.html"
                  ><i data-feather="maximize"></i><span>Print QR Code</span></a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              <li>
                <a href="manage-stocks.html"
                  ><i data-feather="package"></i><span>Manage Stock</span></a
                >
              </li>
              <li>
              ...
              <li>
                <a href="stock-transfer.html"
                  ><i data-feather="truck"></i><span>Stock Transfer</span></a
                >
              </li>
            </ul>
          </li>
            ...
            <ul>
              ...
              <li>
                <a href="inventory-report.html"
                  ><i data-feather="inbox"></i><span>Inventory Report</span></a
                >
              </li>
              <li>
                <a href="invoice-report.html"
              ...
              <li>
                <a href="customer-report.html"
                  ><i data-feather="user"></i><span>Customer Report</span></a
                >
              </li>
              <li>
              ...
              <li>
                <a href="income-report.html"
                  ><i data-feather="bar-chart"></i><span>Income Report</span></a
                >
              </li>
              <li>
              ...
              <li>
                <a href="profit-and-loss.html"
                  ><i data-feather="pie-chart"></i><span>Profit & Loss</span></a
                >
              </li>
            </ul>
          </li>
          ...
          <li class="submenu-open">
            ...
            <ul>
              ...
              <li class="submenu">
                <a href="javascript:void(0);"
                  ><i data-feather="dollar-sign"></i> <span>Settings</span
                  ><span class="menu-arrow"></span>
                </a>
                <ul>
                  <li>
          ...
          <li class="submenu-open">
            ...
            <ul>
              <li>
                <a href="javascript:void(0);"
                  ><i data-feather="file-text"></i><span>Documentation</span></a
                >
              </li>
              <li>
                <a href="javascript:void(0);"
                  ><i data-feather="lock"></i><span>Changelog v2.0.7</span></a
                >
              </li>
              <li class="submenu">
                <a href="javascript:void(0);"
          ...
          <ul class="tab nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="true"
              >
                <img src="/src/assets/img/icons/menu-icon.svg" alt="" />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="false"
              >
                <img src="/src/assets/img/icons/product.svg" alt="" />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="false"
              >
                <img src="/src/assets/img/icons/sales1.svg" alt="" />
              </a>
            </li>
            ...
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="true"
              >
                <img src="/src/assets/img/icons/purchase1.svg" alt="" />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="true"
              >
                <img src="/src/assets/img/icons/users1.svg" alt="" />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="true"
              >
                <img src="/src/assets/img/icons/calendars.svg" alt="" />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a
                ...
                aria-selected="true"
              >
                <img src="/src/assets/img/icons/printer.svg" alt="" />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a
  ...
  <div class="sidebar horizontal-sidebar">
    <div id="sidebar-menu-3" class="sidebar-menu">
      <ul class="nav">
        <li class="submenu">
          <a href="index.html" class="active subdrop"
        ...
        <li class="submenu">
          <a href="javascript:void(0);"
            ><img src="/src/assets/img/icons/product.svg" alt="img" /><span>
              Inventory
            </span>
            <span class="menu-arrow"></span
          ></a>
        ...
        <li class="submenu">
          <a href="javascript:void(0);"
            ><img src="/src/assets/img/icons/purchase1.svg" alt="img" /><span
              >Sales &amp; Purchase</span
            >
            <span class="menu-arrow"></span
          ></a>
        ...
        <li class="submenu">
          <a href="javascript:void(0);"
            ><img src="/src/assets/img/icons/users1.svg" alt="img" /><span
        ...
        <li class="submenu">
          <a href="javascript:void(0);"
            ><img src="/src/assets/img/icons/printer.svg" alt="img" /><span
              >Reports</span
            >
            <span class="menu-arrow"></span
          ></a>
        ...
        <li class="submenu">
          <a href="javascript:void(0);"
            ><img src="/src/assets/img/icons/settings.svg" alt="img" /><span>
              Settings</span
            >
            <span class="menu-arrow"></span
          ></a>
